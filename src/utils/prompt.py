...
class PromptString(Enum):
    ...
    RESPOND = "You are currently talking with {sender}. Given the character's personal info, current plans, location context and conversation history decide what to say next. \n\nName: {full_name}\n\nBio: {private_bio}\n\nGoals: {directives}\n\nRecent Activity: {recent_activity}\n\nCurrent Plans: {current_plans}\n\nLocation Context: {location_context}\n\nConversation History: {conversation_history}\n\nNew Messages: {new_messages}\n\nNew Events: {event_descriptions}."
