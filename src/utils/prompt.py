...
class PromptString(Enum):
    ...
    SHOULD_RESPOND = "Given the chat history, decide if you should respond or not. You be generally conservative with your speech, and only respond when it would be rude not to. Let's Begin!\n\n{format_instructions}\n\nChat History: {conversation_history}\n"
