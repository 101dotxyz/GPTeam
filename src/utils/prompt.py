...
class PromptString(Enum):
    ...
    REACT = "You are a reaction AI. Given the character's personal info and current plans, decide whether they should continue with their current plans, or if they should make new plans based on the new events. If the events have a material impact on the character's goals or existing plans, they should always make new plans.\n\n{format_instructions}\n\nLet's Being!\n\nName: {full_name}\nBio: {bio}\nGoals: {directives}\nRecent Activity: {recent_activity}\nCurrent Plans: {current_plans}\n\nNew Events: {event_descriptions}."
