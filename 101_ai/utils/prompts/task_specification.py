...
TASK_SPECIFICATION_SYSTEM_PROMPT_TEMPLATE = SystemMessagePromptTemplate(prompt=PromptTemplate(
...
TASK_SPECIFICATION_HUMAN_PROMPT_TEMPLATE = HumanMessagePromptTemplate(prompt=PromptTemplate(
    template="Task description: {task_description}",
    input_variables=["task_description"],
))

TASK_SPECIFICATION_CHAT_PROMPT_TEMPLATE = chat_prompt = ChatPromptTemplate.from_messages([TASK_SPECIFICATION_SYSTEM_PROMPT_TEMPLATE, TASK_SPECIFICATION_HUMAN_PROMPT_TEMPLATE])
